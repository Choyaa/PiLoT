...
if __name__ == '__main__':
    ...
    sequences = [
        '/mnt/sda/MapScape/query/images/' +sequence_name,
        '/mnt/sda/MapScape/sup/fast_motion/'+sequence_name + '_pilot',
        '/mnt/sda/MapScape/sup/fast_motion/'+sequence_name + '_pixloc',
        '/mnt/sda/MapScape/sup/fast_motion/'+sequence_name + '_render2loc'
    ]
    target_size = (512, 288)
