...
if __name__ == "__main__":
    # args = parse_args()
    gridsfile = "/mnt/sda/MapScape/3DTiles/chengxiaoya/switzerland_seq6/switzerland_seq6.json"
    savedir = "/mnt/sda/MapScape/3DTiles/chengxiaoya/switzerland_seq6"
    tileset_file = "/mnt/sda/MapScape/3DTiles/chengxiaoya/switzerland_seq6/v1/3dtiles/datasets/CgA/files/tileset.json"
