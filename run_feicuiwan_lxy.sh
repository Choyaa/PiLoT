...
names=(
  ...
  "feicuiwan_sim_seq7"
  "DJI_20251118180052_0003_V"
  "DJI_20251118180014_0002_V"
  "DJI_20251118175925_0001_V"
...
read_pose_from_file() {
  local name="$1"
  local pose_file="/home/ubuntu/Documents/code/LXY/datasets/poses/${name}.txt"
...
for target_name in "${target_names[@]}"; do
  ...
  if [[ $index -ge 0 ]]; then
    ...
    echo "--- fpvloc"
    python main.py \
      --config "/home/ubuntu/Documents/code/github/FPV/PiLoT/configs/feicuiwan_m4t_lxy.yaml" \
      --init_euler "$euler" \
      --init_trans "$trans" \
      --name "$target_name"
