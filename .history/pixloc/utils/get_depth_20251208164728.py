...
def euler_angles_to_matrix_ECEF_batch_special_cuda(euler_angles, translation,
    ...
    rot_pose_in_enu = R.from_euler('xyz', euler_angles[0], degrees=True).as_matrix()  # ZXY 东北天  
    rot_enu_in_ecef = get_rotation_enu_in_ecef(translation[0,0], translation[0,1])
