...
def get_3D_samples_v4(mkpts_r, depth_mat, T_c2w, camera, euler_angles, translation,  query_euler_angles, query_translation, last_frame_info = {}, origin = None, device = 'cuda', num_init_pose = 32, T_query_in_ECEF_c2w = None, mul = None):
    '''
    1. 欧拉角转R， 经纬高转xyz
    2. preprocess_param， [:3, 1] = -[:3, 1], [:3, 2] = - [:3, 2]
    3. * mul
