...
def get_3D_samples_v3(mkpts_r, depth_mat, T_c2w, camera, query_euler_angles, query_translation, last_frame_info = {}, origin = None, device = 'cuda', num_init_pose = 32, T_query_in_ECEF_c2w = None, mul = None):
    ...
    query_euler_angles = generate_rotvecs_cuda_sym3d_only_yaw( base_pitch = query_euler_angles[0], base_roll=query_euler_angles[1], base_yaw=query_euler_angles[2], max_pitch=15.0, pitch_step=2.0, max_yaw=15.0,yaw_step=2.0, max_roll=1.0, roll_step=1.0)
