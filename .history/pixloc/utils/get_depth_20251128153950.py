...
def get_rotation_enu_in_ecef_tensor(lon, lat, device='cuda', dtype=torch.float32):
    ...
    return rot
def euler_to_rotm_batch_v4(angles, translation, degrees=True, device='cuda'):
...
def euler_angles_to_matrix_ECEF_batch_special_cuda_v4(euler_angles, translation, center_pose,
    ...
    translation = torch.tensor(translation, device=device, dtype=torch.float32)
    R_batch = euler_to_rotm_batch_v4(euler_angles, center_pose, degrees=True, device=device)
