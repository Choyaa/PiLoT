...
if __name__ == "__main__":
    # args = parse_args()
    gridsfile = "/mnt/sda/MapScape/3DTiles/chengxiaoya/USA_seq7/USA_seq7.json"
    savedir = "/mnt/sda/MapScape/3DTiles/chengxiaoya/USA_seq7"
    tileset_file = "/mnt/sda/MapScape/3DTiles/chengxiaoya/USA_seq7/v1/3dtiles/datasets/CgA/files/tileset.json"
