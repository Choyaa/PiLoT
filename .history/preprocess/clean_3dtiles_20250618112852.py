...
if __name__ == "__main__":
    # args = parse_args()
    gridsfile = "/mnt/sda/MapScape/3DTiles/chengxiaoya/switzerland_seq5/switzerland_seq5.json"
    savedir = "/mnt/sda/MapScape/3DTiles/chengxiaoya/switzerland_seq5"
    tileset_file = "/mnt/sda/MapScape/3DTiles/chengxiaoya/switzerland_seq5/v1/3dtiles/datasets/CgA/files/tileset.json"
