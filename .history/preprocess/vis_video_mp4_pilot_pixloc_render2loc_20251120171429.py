...
def parallel_video_display(seq_dirs,
    ...
    for i in range(n):
        ...
        for idx, lst in enumerate(lists):
            ...
            label = labels[idx]
            # 添加标签文字
            cv2.putText(img, label, (10, 10), font, 0.6, (0, 0, 0), 4, cv2.LINE_AA)
            cv2.putText(img, label, (10, 10), font, 0.6, (255, 255, 255), 2, cv2.LINE_AA)
...
if __name__ == '__main__':
    ...
    sequence_name = "DJI_20250612194903_0021_V" #DJI_20251118180014_0002_V #DJI_20250612194903_0021_V
    sequences = [
        '/mnt/sda/MapScape/query/images/' +sequence_name,
