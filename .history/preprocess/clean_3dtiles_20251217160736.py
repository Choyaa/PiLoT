...
if __name__ == "__main__":
    # args = parse_args()
    gridsfile = "/mnt/sda/MapScape/3DTiles/chengxiaoya/switzerland_seq4/switzerland_seq4.json"
    savedir = "/mnt/sda/MapScape/3DTiles/chengxiaoya/switzerland_seq4"
    tileset_file = "/mnt/sda/MapScape/3DTiles/chengxiaoya/switzerland_seq4/v1/3dtiles/datasets/CgA/files/tileset.json"
