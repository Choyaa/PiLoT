...
def parallel_video_display(seq_dirs,
    ...
    for i in range(n):
        ...
        qx0 = x_off
        qy0 = y_off
        color_crop = frames[1][qy0:qy0+crop_h, qx0:qx0+crop_w]
        a_frame = frames[0].copy()
        a_frame[y_off:y_off+crop_h, x_off:x_off+crop_w] = color_crop
        ...
        top = np.hstack((frames[0], a_frame))
        bottom = np.hstack((b_frame, c_frame))
