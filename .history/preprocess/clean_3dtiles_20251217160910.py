...
if __name__ == "__main__":
    # args = parse_args()
    gridsfile = "/mnt/sda/MapScape/3DTiles/chengxiaoya/USA_seq4/USA_seq4.json"
    savedir = "/mnt/sda/MapScape/3DTiles/chengxiaoya/USA_seq4"
    tileset_file = "/mnt/sda/MapScape/3DTiles/chengxiaoya/USA_seq4/v1/3dtiles/datasets/CgA/files/tileset.json"
