...
if __name__ == "__main__":
    # args = parse_args()
    gridsfile = "/mnt/sda/MapScape/3DTiles/chengxiaoya/switzerland_seq10/switzerland_seq10.json"
    savedir = "/mnt/sda/MapScape/3DTiles/chengxiaoya/switzerland_seq10"
    tileset_file = "/mnt/sda/MapScape/3DTiles/chengxiaoya/switzerland_seq10/v1/3dtiles/datasets/CgA/files/tileset.json"
