...
if __name__ == "__main__":
    # args = parse_args()
    gridsfile = "/mnt/sda/MapScape/3DTiles/chengxiaoya/switzerland_seq2/switzerland_seq2.json"
    savedir = "/mnt/sda/MapScape/3DTiles/chengxiaoya/switzerland_seq2"
    tileset_file = "/mnt/sda/MapScape/3DTiles/chengxiaoya/switzerland_seq2/v1/3dtiles/datasets/CgA/files/tileset.json"
