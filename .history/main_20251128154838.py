...
class DualProcessTask:        
    ...
    def back_project(self, depth_frame, euler_angles, translation, query_euler_angles, query_translation, num_samples = 500, device = 'cuda'):
        ...
        Points_3D_ECEF, T_render_in_ECEF_w2c_modified, T_initial_pose_candidates, dd = get_3D_samples_v4(points2d, depth, T_render_in_ECEF_c2w, self.render_camera, query_euler_angles, query_translation, origin = self.origin, mul = self.mul)
        # if dd is not None:
        #     self.dd = 
